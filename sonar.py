...
def makeMove(board, chests, x, y):
    # Change the board data structure with a sonar device charcater. Remove treasure chests
    ...
    for cx, cy in chests:
        ...
        if smallestDistance == 0:
            ...
            if smallestDistance < 10:
                ...
                return 'Treasure detected at a distance of %s from the sona service.' %(smallestDistance)
            else:
                board[x][y] = 'O'
                return 'Sonar did not detect anything. All treasure chests out or range.'
...
sonar device. The sonar can find out how far away the cloest chest is to it.
For example, th d below marks where the device was dropped, and the 2's
...
Press enter to continue...''')
    ...
    print('''For example, here is a treaure chest (the c) located a distance of 2 away
...
the location of the chest, and it will be collected. The sonar devce will
remain there.
